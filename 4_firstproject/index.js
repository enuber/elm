...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
				...
				if (_v1.$ === 'Just') {
					...
					if (_v2.$ === 'Just') {
						...
						return _Utils_update(
							model,
							{
								message: 'Happy Birthday ' + (aName + (' !!!! You are ' + ($elm$core$String$fromInt(anAge) + ' years old.')))
							});
					} else {
						return _Utils_update(
							model,
			...
			default:
				var newAge = msg.a;
				var _v3 = $elm$core$String$toInt(newAge);
				if (_v3.$ === 'Just') {
					var anInt = _v3.a;
					return _Utils_update(
						model,
...
var $author$project$Main$viewFistnameInput = function (firstname) {
	return A2(
		$elm$html$Html$input,
		_List_fromArray(
			[
...
var $author$project$Main$viewResetBtn = A2(
	$elm$html$Html$button,
	_List_fromArray(
		[
...
var $author$project$Main$viewSurpriseBtn = A2(
	$elm$html$Html$button,
	_List_fromArray(
		[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$viewFistnameInput(model.firstname),
				$author$project$Main$viewAgeInput(model.age),
				$author$project$Main$viewSurpriseBtn,
				$author$project$Main$viewResetBtn,
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"MsgSurprise":[],"MsgReset":[],"MsgNewName":["String.String"],"MsgNewAgeAsString":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));